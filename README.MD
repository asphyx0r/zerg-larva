...
* A function should always begin with the following identification line, allowing for its description during logging:
&emsp;&emsp;`local functionName="custom_user_function()"`
