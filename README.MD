...
### v1.0.3 - Improved return code management (30/11/2025)
...
6. **Line 39** to **Line 45**, list all the exit codes used by the script. The free range is **0–125**:
...
**128+N**:   The command terminated due to signal N\
Example: 130 = 128+2\
SIGINT = 2
